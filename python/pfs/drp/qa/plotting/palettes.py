"""Shared palettes and the standard residual scatter plot.

Moved here from ``pfs.drp.qa.utils.plotting``, which now re-exports this module
so existing imports keep working. Like everything under
`pfs.drp.qa.plotting`, this imports no Butler and no task class.
"""
